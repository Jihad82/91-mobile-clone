...
const StoriesSection = ({ stories }: { stories: NewsItem[] }) => {
  return (
    <section className="bg-gray-50 dark:bg-gray-800 py-8 mb-4 border-y border-gray-200 dark:border-gray-700 transition-colors duration-300">
      <div className="container mx-auto max-w-[1200px] px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stories.map((story) => (
            <div key={story.id} className="bg-white dark:bg-gray-900 p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-gray-100 dark:border-gray-700">
