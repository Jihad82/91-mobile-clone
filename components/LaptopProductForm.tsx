    ...
    <div className="flex flex-col h-full bg-[#0f172a] text-gray-100">
        ...
        <div className="h-14 border-b border-gray-800 bg-[#1e293b] flex items-center justify-between px-6 shrink-0">
             <div className="flex items-center gap-4">
                 ...
                 <h2 className="font-bold text-white">{formData.id ? 'Edit Laptop' : 'Add New Laptop'}</h2>
             ...
             <div className="flex items-center gap-3">
                 <button onClick={() => onSave(formData as LaptopProduct)} className="px-4 py-2 bg-primary hover:bg-primary-dark text-black rounded-lg text-xs font-bold">Publish</button>
             </div>
        </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 border-r border-gray-800">
                ...
                {activeTab === 'specs' && (
                    <div className="max-w-3xl animate-fade-in">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                            ...
                            <Input label="Brand" field="brand" placeholder="Apple" />
                            <Input label="Model" field="model" placeholder="MacBook Air M3" />
                            ...
                            <Input label="Processor Model" field="processor_name" placeholder="Core i7-13700H" />
                            <Input label="Cores" field="cores" type="number" />
                            <Input label="Graphics Model" field="graphics_model" placeholder="RTX 4060" />
                            ...
                            <Input label="RAM Type" field="ram_type" placeholder="LPDDR5" />
                            ...
                            <Input label="Resolution" field="resolution" placeholder="2560 x 1664" />
                            <div className="col-span-2">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" checked={formData.touchscreen} onChange={e => handleChange('touchscreen', e.target.checked)} className="rounded bg-gray-900 border-gray-700"/>
                                    <span className="text-sm font-bold text-gray-300">Touchscreen</span>
                                </label>
                            </div>
                            ...
                            <Input label="OS" field="os" placeholder="Windows 11" />
                ...
                {activeTab === 'seo' && (
                    <div className="max-w-3xl space-y-4 animate-fade-in">
                        <Input label="URL Slug" field="slug" placeholder="apple-macbook-air-m3" help="Auto-generated from Brand + Model" />
                        <Input label="Meta Title" field="meta_title" placeholder="Apple MacBook Air M3 Price in Bangladesh..." />
                        <div className="mb-4">
                ...
                <div className="flex-1 overflow-y-auto bg-white p-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 mb-4">
                        ...
                        <div className="grid grid-cols-2 gap-y-3 gap-x-2 text-xs">
                             ...
                             <div className="font-bold text-gray-800 text-right">{formData.processor_name || '-'}</div>
                             
                             <div className="text-gray-500">RAM</div>
                             <div className="font-bold text-gray-800 text-right">{formData.ram_gb}GB</div>
                             
                             <div className="text-gray-500">Storage</div>
                             <div className="font-bold text-gray-800 text-right">{formData.storage_capacity_gb}GB {formData.storage_type}</div>
